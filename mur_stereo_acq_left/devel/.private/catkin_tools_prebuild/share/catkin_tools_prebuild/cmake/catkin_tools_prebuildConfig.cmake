...
if("TRUE" STREQUAL "TRUE")
  set(catkin_tools_prebuild_SOURCE_PREFIX /workspace/both_cam_acq/mur_stereo_acq_left/build/catkin_tools_prebuild)
  set(catkin_tools_prebuild_DEVEL_PREFIX /workspace/both_cam_acq/mur_stereo_acq_left/devel/.private/catkin_tools_prebuild)
  ...
  set(catkin_tools_prebuild_INSTALL_PREFIX /workspace/both_cam_acq/mur_stereo_acq_left/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/both_cam_acq/mur_stereo_acq_left/build/catkin_tools_prebuild/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /workspace/both_cam_acq/mur_stereo_acq_left/devel/.private/catkin_tools_prebuild/lib;/workspace/both_cam_acq/mur_stereo_acq_left/devel/lib;/opt/ros/melodic/lib)
