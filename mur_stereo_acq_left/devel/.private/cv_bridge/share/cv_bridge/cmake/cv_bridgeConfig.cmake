...
if("TRUE" STREQUAL "TRUE")
  set(cv_bridge_SOURCE_PREFIX /workspace/both_cam_acq/mur_stereo_acq_left/src/mur_stereo_basler/includes/cv_bridge)
  set(cv_bridge_DEVEL_PREFIX /workspace/both_cam_acq/mur_stereo_acq_left/devel/.private/cv_bridge)
  ...
  set(cv_bridge_INSTALL_PREFIX /workspace/both_cam_acq/mur_stereo_acq_left/install)
...
if(NOT "/workspace/both_cam_acq/mur_stereo_acq_left/src/mur_stereo_basler/includes/cv_bridge/include;/usr/local/include/opencv4 " STREQUAL " ")
  set(cv_bridge_INCLUDE_DIRS "")
  set(_include_dirs "/workspace/both_cam_acq/mur_stereo_acq_left/src/mur_stereo_basler/includes/cv_bridge/include;/usr/local/include/opencv4")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/both_cam_acq/mur_stereo_acq_left/src/mur_stereo_basler/includes/cv_bridge/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /workspace/both_cam_acq/mur_stereo_acq_left/devel/.private/cv_bridge/lib;/workspace/both_cam_acq/mur_stereo_acq_left/devel/lib;/opt/ros/melodic/lib)
